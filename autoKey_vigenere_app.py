...
from ciphers.autoKeyVignere import *
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Load the UI file
        loadUi('windows/autoKey_vigenere_window.ui', self)
    ...
    def on_encrypt_button_clicked(self):
        ...
        output = encrypt_autoKeyVignere(input_text, input_key)
    ...
    def on_decrypt_button_clicked(self):
        ...
        output = decrypt_autoKeyVigenere(input_text, input_key)
        self.output_box.setPlainText(output)
